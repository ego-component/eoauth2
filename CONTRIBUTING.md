...
## 1 Fork 代码
1. 访问 https://github.com/ego-component/eoauth2
...
```bash
git clone https://github.com/ego-component/eoauth2.git
cd ego
git remote add upstream 'git@github.com:<your github username>/eoauth2.git'
```
...
## 8 提交 PR
访问 https://github.com/ego-component/eoauth2, 
